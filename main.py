...
from modules.classes import Template                        # Template class
from modules.prepareScope import create_original_asset_list # Preparation script
from modules.validateScope import validateScopeObjects      # Validation script
...
def main():
    ...
    print(logo)
    #TODO add arg to turn on safe mode so nmap doesnt scan hosts
    ...
    # print("\n\n-=- The results are in -=-")
    # for asset in validated_scope:
    #     print("\nMain asset: {}".format(asset.main_asset.strip("\n")))
    #     if asset.host_uri:
    #         print("|= Host output: {}".format(asset.host_results))
    #         if asset.host_zonetransfer_results:
    #             # print("|= Zonetransfer output: {}"\
    #                 # .format(asset.host_zonetransfer_results))
    #             pass
    #     if asset.curl_uri:
    #         print("|= Curl output: {}".format(asset.curl_results))

    #     if asset.nmap_uri:
    #         print("|= Nmap output: {}\n".format(asset.nmap_results))
